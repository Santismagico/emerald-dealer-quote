...
| 2026-07-17 | C10: desplazamiento del cotizador en Android (Codex) | El contenido usa desplazamiento táctil propio y la navegación del formulario permanece accesible; 467 pruebas y build en verde; publicación autorizada por Santiago | este commit |
| 2026-07-17 | E5: adaptación para computador (Codex) | La app usa el ancho disponible, menú lateral y formulario en columnas sin alterar la presentación móvil; 467 pruebas y build en verde; publicación autorizada por Santiago | este commit |
