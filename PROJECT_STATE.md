...
_Actualizado: 2026-07-11 por Codex al completar la Etapa 2. Este archivo es la foto del estado real; cualquier agente debe poder continuar leyendo solo esto y los documentos que enlaza._
...
- **Versión:** 0.5.0 + cambios no publicados de las Etapas 1 y 2 en la rama Fable. No se cambió la versión ni se publicó.
...
- Rama de trabajo autorizada: `fable/regeneracion-emerald-dealer-quote-v1`. Las Etapas 1 y 2 quedan en commits locales, sin push.
...
- `npm test`: 181 tests en verde (10 archivos).
...
Las **Etapas 1 y 2 están completadas**. La siguiente recomendación es la Etapa 3: guardado eficiente en producción y abonos, solo después de una nueva autorización de Santiago.
...
| 2026-07-11 | Etapa 2: vencimiento como estado derivado | Historial, filtros y conteos coherentes, sin escrituras automáticas; 181 tests y build en verde | Este commit |
