...
| S8-C1 | F | Completar los Excel internos con columnas separadas por socio y una hoja del fondo por persona, con aportes, pagos, vencimientos y saldo | excelExport, Panel, Cierres, Consolidado | verificada; no publicada | 195377b |
| S9-C1 | F | Llevar a la nube los varios socios y el fondo persona por persona, con aislamiento entre joyerías, validación de cifras y sincronización entre dispositivos | cloud, migración Supabase, importación y N6 | preparada y verificada localmente; falta migración y N6 en vivo; no publicada | este commit |
