...
| E8 | E | En celular, hacer que “Registrar venta” sea una pantalla clara con encabezado y botones siempre visibles; en computador conservar un diálogo centrado | ui, StonesView, index.css | en curso (Codex) | pendiente |
| E9 | E | Hacer inequívoca la elección Contado/A crédito y mejorar contraste, estado y accesibilidad de todos los interruptores | ui, StonesView, index.css | en curso (Codex) | pendiente |
