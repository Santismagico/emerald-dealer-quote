...
| E7 | E | En PC, devolver Siguiente/Anterior y Guardar ajustes a su posición normal; ningún botón queda anclado | QuoteForm, SettingsView, index.css | verificada; pendiente de publicación | pendiente |
