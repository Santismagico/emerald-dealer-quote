...
| E6 | E | En Android, devolver Siguiente/Anterior a su posición normal sin perder el desplazamiento corregido | QuoteForm, index.css | verificada; pendiente de publicación | pendiente |
