...
>
> Versión técnica: `draft-2026-07-20`. No debe presentarse como aviso definitivo hasta completar los campos pendientes y recibir aprobación profesional.

Emerald Dealer, operado por [COMPLETAR: nombre completo / NIT], trata los datos de identificación, contacto y operación que la joyería registra para crear la cuenta, prestar el servicio, administrar cotizaciones, clientes, proveedores, citas, trabajos de taller, pagos e inventario de piedras, brindar soporte y cumplir obligaciones legales.
...
Como titular puedes conocer, actualizar, rectificar y solicitar la supresión de tus datos, así como revocar la autorización cuando legalmente proceda. Ejerce tus derechos en [COMPLETAR: correo/WhatsApp].
