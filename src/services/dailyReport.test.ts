  ...
  it('las compras y ventas de piedras se filtran por su fecha', () => {
    const lots = [
      ...
      lote({
        ...
        sales: [
          { id: 'v-hoy', date: DAY, buyer: 'Comprador', carats: 1, quantity: 1, valueCop: 2000000, buyerId: null, onCredit: false, dueDate: '', payments: [], method: 'Efectivo', receivedBy: 'Santiago', notes: '' },
          { id: 'v-ayer', date: '2026-07-14', buyer: '', carats: 1, quantity: 1, valueCop: 900000, buyerId: null, onCredit: false, dueDate: '', payments: [], method: 'Efectivo', receivedBy: 'Santiago', notes: '' }
        ]
      })
    ];
  ...
  it('suma entradas, salidas y calcula el neto', () => {
    const lots = [
      ...
      lote({
        id: 'l-venta',
        purchaseDate: '2026-07-01',
        sales: [{ id: 'v-1', date: DAY, buyer: '', carats: 1, quantity: 1, valueCop: 2500000, buyerId: null, onCredit: false, dueDate: '', payments: [], method: 'Efectivo', receivedBy: 'Santiago', notes: '' }]
      })
    ];
    const quote = sampleQuote({
      date: '2026-07-01',
...
describe('cierre del mes (C6)', () => {
  const julio = [
    ...
    lote({
      ...
      sales: [{ id: 'v-jul', date: '2026-07-20', buyer: '', carats: 1, quantity: 1, valueCop: 3000000, buyerId: null, onCredit: false, dueDate: '', payments: [], method: 'Efectivo', receivedBy: 'Santiago', notes: '' }]
    })
  ];
